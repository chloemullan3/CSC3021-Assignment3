...
public class LockFreeHashMap<K,V> implements Map<K, V> {
    ...
    private synchronized BucketListMap<K,V> getBucketListMap(int myBucket) {
	if (bucket[myBucket] == null)
	    initializeBucket(myBucket);
	return bucket[myBucket];
    }
    private synchronized void initializeBucket(int myBucket) {
    ...
    private synchronized int getParent(int myBucket){
